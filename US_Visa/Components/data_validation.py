...
class DataValidation:
    ...
    def validate_the_number_of_columns(self,dataframe:DataFrame) -> bool:
    ...
    def detect_dataset_drift(self,reference_data:DataFrame,current_data:DataFrame):
        try:
            ...
            write_yaml_file(self.data_validation_config.drift_report_file_path,content=json_report)
    ...
    def initiate_data_validation(self) -> DataValidationArtifact:
        ...
        try:
            ...
            status=self.validate_the_number_of_columns(train_df)
            if not status:
